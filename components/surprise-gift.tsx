...
export default function SurpriseGift({ content }: SurpriseGiftProps) {
  ...
  const handleClaim = () => {
    setClaimed(true);
    alert("¡Regalo reclamado con éxito! Te contactaremos pronto para organizar tu sorpresa.");
  };
  ...
  return (
    <div className="max-w-2xl mx-auto w-full px-4 sm:px-6 md:px-8">
      <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-lg p-4 sm:p-6 md:p-8 shadow-lg border border-yellow-100">
        ...
        <div className="text-center">
          <Button className="bg-orange-500 hover:bg-orange-600 text-white" onClick={handleClaim}>
            <Gift className="w-4 h-4 mr-2" />
            {claimed ? "¡Regalo Reclamado!" : "Reclamar Regalo"}
          </Button>
        </div>
